...
export default class MovieScreen extends React.Component {
  ...
  componentDidMount() {
     console.log("this.props Keys: "+Object.keys(this.props.route.params)+", this.props Values: "+Object.values(this.props.route.params))
    return fetch(`https://www.omdbapi.com/?apikey=a0a882ab&i=${this.props.route.params.imdbID}&plot=full`)
